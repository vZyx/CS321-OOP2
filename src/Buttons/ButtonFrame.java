package Buttons;// Fig. 12.15: Buttons.ButtonFrame.java
...
public class ButtonFrame extends JFrame{
    ...
    // Buttons.ButtonFrame adds JButtons to JFrame
    public ButtonFrame(){
        ...
        Icon bug1 = new ImageIcon(getClass().getResource("Buttons/bug1.gif"));
        Icon bug2 = new ImageIcon(getClass().getResource("Buttons/bug2.gif"));
