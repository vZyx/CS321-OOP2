package Buttons;
// Fig. 12.17: Buttons.CheckBoxFrame.java
...
public class CheckBoxFrame extends JFrame
{
    ...
    // Buttons.CheckBoxFrame constructor adds JCheckBoxes to JFrame
    ...
    {
        // respond to checkbox events @Override
        @Override
        public void itemStateChanged(ItemEvent event)
        {
            ...
            if (boldJCheckBox.isSelected() && italicJCheckBox.isSelected()) font = new Font("Serif", Font.BOLD + Font.ITALIC, 14);
            else if (boldJCheckBox.isSelected())
                font = new Font("Serif", Font.BOLD, 14);
            else if (italicJCheckBox.isSelected())
                font = new Font("Serif", Font.ITALIC, 14);
            else
                font = new Font("Serif", Font.PLAIN, 14); textField.setFont(font);
